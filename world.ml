...
(* type t = { maps : (string, AreaMap.t) Hashtbl.t; start_map : AreaMap.t; } *)
...
let get_tile row col map =
  try map.tiles.((row * map.cols) + col) with Invalid_argument x -> Blank
...
let get_init_map foldername = failwith "unimplemented"

let get_map world name = failwith "unimplemented"

(* let switch_map world name = failwith "unimplemented" *)

let list_maps world name = failwith "unimplemented"

let get_start_map world = failwith "unimplemented"
