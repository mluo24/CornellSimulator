MODULES=main position gameGaugesDict gameDataStructure keyValueType drawable rect state author world item gauges character imageHandler mission areaMap
OBJECTS=$(MODULES:=.cmo)
MLS=$(MODULES:=.ml)
MLIS=$(MODULES:=.mli)
TEST=test.byte
